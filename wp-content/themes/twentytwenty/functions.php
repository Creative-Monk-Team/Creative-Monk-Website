...
// Disable automatic big image resizing
...
function enable_lightbox_on_custom_post_types($args) {
    if (is_singular('portfolio') || is_singular('company')) {
        wp_enqueue_script('simple-lightbox', plugins_url('simple-lightbox/simple-lightbox.min.js'), array('jquery'), null, true);
        wp_enqueue_style('simple-lightbox-style', plugins_url('simple-lightbox/simple-lightbox.min.css'));
    }
}
add_action('wp_enqueue_scripts', 'enable_lightbox_on_custom_post_types');
    ...
    if (is_singular('portfolio') || is_singular('company')) {
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                if (window.SimpleLightbox && lightboxLinks.length > 0) {
...
require_once get_template_directory() . "/clients-admin.php";
require_once get_template_directory() . "/testimonial-admin.php";
require_once get_template_directory() . "/blog-admin.php";
require_once get_template_directory() . '/portfolio-admin.php';
require_once get_template_directory() . '/team-admin.php';
require_once get_template_directory() . '/service-admin.php';
require_once get_template_directory() . '/contact-admin.php';
