...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg"
    ...
    <div class="container">
        <div class="cs-page_heading_in">
            <h1 class="cs-page_title cs-font_50 cs-white_color">Social Media Services In Chandigarh</h1>
        </div>
    </div>
</div>
...
<div class="container mx-auto flex flex-col items-center py-20">
    <h2 class="text-center ">Unlock the Power of Social Media for Your Brand</h2>
    <p class="text-white/25 text-center text-lg">Social Media Services by Creative Monk encompass a full spectrum of activities designed to boost your brand’s online presence. From crafting compelling content to managing your community, we ensure your brand thrives on social media.</p>
</div>


<div class="container mx-auto flex flex-col items-center py-20">
    <h5 class="" style="color: #ff6900;">Social Media</h5>
    ...
    <div class="flex flex-col md:flex-row gap-2 items-center justify-center py-2 mt-10">
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Engaging Content</h5>
        </div>
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Strategic Planning</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-black p-4 flex flex-col gap-2 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-md shadow-[#ff6900]">
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Lead Generation</h5>
        </div>
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Increased Visibility</h5>
        </div>
    </div>
</div>
...
<div class="flex flex-col md:flex-row items-center justify-center gap-10 w-full container mx-auto py-10">
    ...
    <div class="md:w-7/12 flex flex-col gap-2">
        <h3 class="text-start">How We Elevate Your Social Media Game</h3>
        <div class="flex flex-col gap-2 text-white/25">
            <p>Creative Monk takes a holistic approach to social media, ensuring every post and interaction contributes to your overall brand strategy.</p>
        </div>
        
    </div>
    <div class="md:w-5/12"><img class="h-full w-full"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2024/08/194.jpg" alt="">
    </div>
</div>
...
<section id="items" class="container mx-auto py-20 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10">
    <div
        ...
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            ...
            class="text-white text-lg text-center">Targeted Advertising</span></div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/label.png" alt=""><span
            class="text-white text-lg text-center">Data-Driven Insights</span></div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/medicine.png" alt=""><span
            class="text-white text-lg text-center">Influencer Partnerships</span></div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/drink.png" alt=""><span
            class="text-white text-lg text-center">Audience Engagement</span></div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/gift.png" alt=""><span
            class="text-white text-lg text-center">Competitive Advantage</span></div>
</section>
