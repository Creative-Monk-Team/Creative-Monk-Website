...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg"
    ...
    <div class="container">
        <div class="cs-page_heading_in">
            <h1 class="cs-page_title cs-font_50 cs-white_color">Elevate Your Professional Network with Creative Monk’s LinkedIn Marketing</h1>
        </div>
    </div>
</div>
...
<div class="container mx-auto flex flex-col items-center py-20">
    <h2 class="text-center ">Boost Your Business Presence with LinkedIn Marketing</h2>
    <p class="text-white/25 text-center text-lg">LinkedIn Marketing is all about leveraging the professional network to build brand authority, connect with industry leaders, and generate B2B leads. With its focus on professional networking, LinkedIn offers unique opportunities for businesses to engage with a highly targeted audience.</p>
</div>


<div class="container mx-auto flex flex-col items-center py-20">
    <h5 class="" style="color: #ff6900;">LinkedIn Marketing</h5>
    <h2 class="text-center my-2">Key Elements of LinkedIn Marketing</h2>
    ...
    <div class="grid grid-cols-2 md:flex flex-col md:flex-row gap-6 md:gap-2 items-center justify-center py-2 mt-10">
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Profile Optimization</h5>
        </div>
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Content Sharing</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-black p-4 md:p-0 flex flex-col gap-4 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-custom transition-shadow shadow-[#ff6900]">
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Networking</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-white p-4 md:p-0 flex flex-col gap-4 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-custom transition-shadow shadow-[#ff6900]">
...
<div class="flex flex-col md:flex-row items-center justify-center gap-10 w-full container mx-auto py-10">
    ...
    <div class="md:w-6/12"><img class="h-full w-full object-cover rounded"
            src="	https://binnysfoodart.in/cmnew/wp-content/uploads/2024/08/21251653_6447055-scaled.jpg"
            alt="">
    </div>
</div>
