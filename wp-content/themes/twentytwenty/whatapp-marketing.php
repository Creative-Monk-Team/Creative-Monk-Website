...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg"
    ...
    <div class="container">
        <div class="cs-page_heading_in">
            <h1 class="cs-page_title cs-font_50 cs-white_color">Personalize Your Customer Interactions with Creative Monk’s WhatsApp Marketing</h1>
        </div>
    </div>
</div>
...
<div class="container mx-auto flex flex-col items-center py-20">
    <h2 class="text-center ">Transform Communication with WhatsApp Marketing</h2>
    <p class="text-white/25 text-center text-lg">WhatsApp Marketing leverages the popular messaging app to provide personalized communication, customer support, and promotional messages directly to users. With over 2 billion users, WhatsApp is a powerful platform for engaging customers personally and effectively.</p>
</div>


<div class="container mx-auto flex flex-col items-center py-20">
    <h5 class="" style="color: #ff6900;">WhatsApp Marketing</h5>
    <h2 class="text-center my-2">Essential Components of WhatsApp Marketing</h2>
    ...
    <div class="grid grid-cols-2 md:flex flex-col md:flex-row gap-6 md:gap-2 items-center justify-center py-2 mt-10">
        <div
            ...
            <svg fill="#ff6900" style="height: 10rem; width: 10rem;" class="" xmlns="http://www.w3.org/2000/svg" id="Capa_1"
                viewBox="0 0 511.625 511.625" >
                <g>
                    <path
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Direct Messaging</h5>
        </div>
        ...
        <div
            ...
            <svg fill="#ff6900" style="height: 10rem; width: 10rem;" class="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Broadcast Lists</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-black p-4 md:p-0 flex flex-col gap-4 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-custom transition-shadow shadow-[#ff6900]">
            <svg fill="#ff6900" style="height: 10rem; width: 10rem;" class="" xmlns="http://www.w3.org/2000/svg" id="icons" viewBox="0 0 64 64"
                >
                <path
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Groups</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-white p-4 md:p-0 flex flex-col gap-4 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-custom transition-shadow shadow-[#ff6900]">
            <svg fill="#ff6900" style="height: 10rem; width: 10rem;" class="" xmlns="http://www.w3.org/2000/svg" id="Layer_5" viewBox="0 0 62 62"
                >
                <g>
                    <path
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Status Updates</h5>
        </div>

        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-black p-4 md:p-0 flex flex-col gap-4 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-custom transition-shadow shadow-[#ff6900]">
            <svg fill="#ff6900" style="height: 10rem; width: 10rem;" class="" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 124 124"
                >
                <path
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Customer Support</h5>
        </div>
    </div>
</div>
...
<div class="flex flex-col md:flex-row items-center justify-center gap-10 w-full container mx-auto py-10">
    ...
    <div class="md:w-7/12 flex flex-col gap-2">
        <h3 class="text-start">Our WhatsApp Marketing Strategy</h3>
        <div class="flex flex-col gap-2 text-white/25">
            <p>At Creative Monk, we create tailored WhatsApp marketing strategies to enhance customer engagement and drive conversions.</p>
        </div>
        <div id="whyus" class="flex flex-col gap-2">
            ...
            <div>
                <p>We conduct in-depth research to understand your brand, target audience, and market trends, ensuring that our designs align with your objectives.</p>
            </div>
            <h5 class="bg-transparent whyus cursor-pointer" style="border:none"><span><i
                        class="fa-solid fa-caret-right me-2"></i></span> Clarify Your Strategy</h5>
            <div>
                <p>We work closely with you to define a clear and effective packaging strategy, emphasizing your brand’s unique selling points.</p>
            </div>
            <h5 class="bg-transparent whyus cursor-pointer" style="border:none"><span><i
                        class="fa-solid fa-caret-right me-2"></i></span>Design Your Elements</h5>
            <div>
                <p>Our talented designers craft visually captivating packaging elements that tell your brand’s story and capture the essence of your products.</p>
            </div>
            <h5 class="bg-transparent whyus cursor-pointer" style="border:none"><span><i
                        class="fa-solid fa-caret-right me-2"></i></span>Create Your Touchpoints</h5>
            <div>
                <p>We design packaging that engages your customers at every touchpoint, from initial impression to unboxing, leaving a memorable and positive impact.</p>
            </div>
        </div>
    </div>
    <div class="md:w-5/12"><img class="h-full w-full object-cover rounded"
            src="https://img.freepik.com/free-photo/realistic-phone-with-social-media_23-2151459598.jpg?uid=P79144589&ga=GA1.1.1876450538.1689768952&semt=ais_items_boosted&w=740"
            alt="">
    </div>
</div>
...
<section id="items" class="container mx-auto py-20 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10">
    <div
        ...
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            ...
            class="text-white text-lg text-center">High Open Rates</span>
    </div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
    ...
    <div
        ...
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            ...
            class="text-white text-lg text-center">Customer Loyalty</span>
    </div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/drink.png" alt=""><span
            class="text-white text-lg text-center">Performance Tracking</span>
    </div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/gift.png" alt=""><span
            class="text-white text-lg text-center">Customer Interaction</span>
    </div>
</section>
