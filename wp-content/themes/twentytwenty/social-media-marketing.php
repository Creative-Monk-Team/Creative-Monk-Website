...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg"
    ...
    <div class="container">
        <div class="cs-page_heading_in">
            <h1 class="cs-page_title cs-font_50 cs-white_color">Amplify Your Brand with Creative Monk’s Social Media
                Marketing</h1>
        </div>
    </div>
</div>
...
<div class="container mx-auto flex flex-col items-center py-20">
    <h2 class="text-center ">What is Social Media Marketing?</h2>
    <p class="text-white/25 text-center text-lg">Social Media Marketing is the practice of using social media platforms
        to connect with your audience, build your brand, increase sales, and drive website traffic. This involves
        publishing great content, engaging your followers, and running targeted advertisements to reach your desired
        audience.</p>
</div>
...
<div class="container mx-auto flex flex-col items-center py-20">
    ...
    <h2 class="text-center my-2">Core Components of Social Media Marketing</h2>
    ...
    <div class="flex flex-col md:flex-row gap-2 items-center justify-center py-2 mt-10">
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Content Creation</h5>
        </div>
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Audience Engagement</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-black p-4 flex flex-col gap-2 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-md shadow-[#ff6900]">
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Advertising</h5>
        </div>
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Influencer Collaborations</h5>
        </div>
    </div>
</div>
...
<div class="flex flex-col md:flex-row items-center justify-center gap-10 w-full container mx-auto py-10">
    ...
    <div class="md:w-7/12 flex flex-col gap-2">
        <h3 class="text-start">Our Social Media Marketing Approach</h3>
        <div class="flex flex-col gap-2 text-white/25">
            <p>At Creative Monk, we tailor our social media strategies to meet your unique business needs, ensuring your
                brand shines across all platforms.</p>
        </div>
        <span class="text-lg font-bold text-white">In the package design process:</span>
        <div id="whyus" class="flex flex-col gap-2">
            ...
            <div>
                <p>Our talented designers craft visually captivating packaging elements that tell your brand’s story and
                    capture the essence of your products.
                </p>
            </div>
            <h5 class="bg-transparent whyus cursor-pointer" style="border:none"><span><i
    ...
    <div class="md:w-5/12"><img class="h-full w-full"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/6626192_3368443-min-1.jpg" alt="">
    </div>
</div>
...
<section id="items" class="container mx-auto py-20 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10">
    <div
        ...
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            ...
            class="text-white text-lg text-center">Increased Brand Awareness
        </span>
    </div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
