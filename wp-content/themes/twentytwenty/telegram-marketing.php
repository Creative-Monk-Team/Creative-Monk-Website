...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg"
    ...
    <div class="container">
        <div class="cs-page_heading_in">
            <h1 class="cs-page_title cs-font_50 cs-white_color">Reach Your Audience Directly with Creative Monk’s Telegram Marketing</h1>
        </div>
    </div>
</div>
...
<div class="container mx-auto flex flex-col items-center py-20">
    <h2 class="text-center ">Unlock Direct Communication with Telegram Marketing</h2>
    <p class="text-white/25 text-center text-lg">Telegram Marketing uses the messaging app Telegram to broadcast messages to a large audience, create interactive communities, and share content instantly. With its powerful features, Telegram is a great tool for direct engagement and real-time communication.</p>
</div>


<div class="container mx-auto flex flex-col items-center py-20">
    <h5 class="" style="color: #ff6900;">Telegram Marketing</h5>
    <h2 class="text-center my-2">Key Features of Telegram Marketing</h2>
    ...
    <div class="grid grid-cols-2 md:flex flex-col md:flex-row gap-6 md:gap-2 items-center justify-center py-2 mt-10">
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Broadcast Messages</h5>
        </div>
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Interactive Groups</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-black p-4 md:p-0 flex flex-col gap-4 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-custom transition-shadow shadow-[#ff6900]">
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Channels</h5>
        </div>
        <span class="hidden md:block h-[2px] w-20 bg-white/50"></span>
        <div
            class="bg-white p-4 md:p-0 flex flex-col gap-4 items-center justify-center rounded-xl w-full md:w-40 h-52 md:h-40 hover:shadow-custom transition-shadow shadow-[#ff6900]">
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Bots</h5>
        </div>
        ...
        <div
            ...
            <h5 class="text-center" style="color:gray; font-size: 12px;">Analytics</h5>
        </div>
    </div>
</div>
...
<div class="flex flex-col md:flex-row items-center justify-center gap-10 w-full container mx-auto py-10">
    ...
    <div class="md:w-7/12 flex flex-col gap-2">
        <h3 class="text-start">Our Telegram Marketing Approach</h3>
        <div class="flex flex-col gap-2 text-white/25">
            <p>At Creative Monk, we utilize Telegram’s unique features to create effective marketing campaigns that foster direct engagement and community building.</p>
        </div>
    ...
    <div class="md:w-5/12"><img class="h-full w-full"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2024/08/94.jpg"
            alt="">
    </div>
</div>
...
<section id="items" class="container mx-auto py-20 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10">
    <div
        ...
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            ...
            class="text-white text-lg text-center">Direct Reach</span>
    </div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
    ...
    <div
        ...
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            ...
            class="text-white text-lg text-center">Real-Time Updates</span>
    </div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/drink.png" alt=""><span
            class="text-white text-lg text-center">Automation</span>
    </div>
    <div
        class=" w-full bg-transparent rounded-2xl hover:shadow-custom duration-500 p-10 flex flex-col items-center justify-center gap-4 transition-shadow">
        <img class="w-full" style="height: 6rem; object-fit: contain;"
            src="https://binnysfoodart.in/cmnew/wp-content/uploads/2023/09/gift.png" alt=""><span
            class="text-white text-lg text-center">Community Building</span>
    </div>
</section>
